# Ручной деплой webclip-installer.py
...
# Сделай бэкап
sudo cp /opt/lara-ota/server.py /opt/lara-ota/server.py.backup

# Создай новый server.py
...
## Готово!
Открой: https://liver-vintage-marco-thus.trycloudflare.com
